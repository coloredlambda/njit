...
export const createHashPassword = () => async password => bcrypt.hash(password, 8)

export const createComparePassword = () => async ({ password, hashedPassword }) => bcrypt.compare(password, hashedPassword)
